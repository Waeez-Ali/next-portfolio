         ...
         <h1 className="text-[50px] text-white font-semibold">
          ...
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-500 to-red-500"> 
           ...
           <p className="text-gray-200 hidden md:block">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Accusantium nobis maxime quae commodi amet est alias ut molestias fuga! Nihil sequi consequuntur vitae velit quam, ducimus doloremque iure labore non?
           </p>
